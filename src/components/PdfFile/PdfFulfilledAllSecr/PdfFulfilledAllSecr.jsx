...
const PdfFulfilledAllSecr = ({ editorRef }) => {
  ...
  const initialContent = `
    <main style="font-family:Times New Roman, Times, serif !important; font-size:14pt; position: relative; padding-top: 180px;">
            <img src="data:image/jpg;base64,${imgBase64Addres}" alt=""  height="100px" width:"300px" style="position: absolute; top: 60px; left: 0px;">
            <img src="data:image/jpg;base64,${imgBase64Logo}" alt=""  height="120px" width:"30px" style="position: absolute; top: 40px; right: -10px;">
